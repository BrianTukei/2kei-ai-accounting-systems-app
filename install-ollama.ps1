...
try {
    $testResponse = Invoke-WebRequest -Uri "http://localhost:11434/api/generate" -Method POST -ContentType "application/json" -Body '{"model": "llama3", "prompt": "Hello", "stream": false}' -UseBasicParsing -TimeoutSec 10
